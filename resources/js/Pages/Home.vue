        ...
        <div class="mx-auto lg:pl-0 md:pl-[80px] pl-0">
            <Carousel v-model="currentSlide" class="max-w-[700px] mx-auto" :items-to-show="wWidth >= 768 ? 8 : 6"
                ...
                <Slide v-for="slide in 10" :key="slide">
                    ...
                    <img class="rounded-full w-[56px] h-[56px] -mt-[1px]" src="https://picsum.photos/id/50/300/320">
                    <div class="text-xs mt-2 w-[60px] truncate text-ellipsis overflow-hidden">User Name</div>
                    </Link>
                </Slide>
